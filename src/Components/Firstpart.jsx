...
function Firstpart({handleaddtask , inputvalue , handlesetinputvalue}) {
  return (
    ...
    <input onChange={handlesetinputvalue} placeholder='Enter the task.....' className='placeholder-shown:pl-1 pl-1 between:h-10 between:w-56 between:mx-2 w-96 h-10 between:rounded-md rounded-md focus:outline-none'  type="text"  value={inputvalue} />
